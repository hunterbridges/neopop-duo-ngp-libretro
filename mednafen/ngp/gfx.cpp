...
int neopop_gfx_t::StateAction(void *data, int load, int data_only)
{
   StateMem *sm = (StateMem*)data;
   SFORMAT StateRegs[] =
   {
      { &(NGPGfx.raster_line), sizeof(NGPGfx.raster_line), 0x80000000, "raster_line" },
      { &(NGPGfx.S1SO_H), (uint32_t)(SF_IS_BOOL(&(NGPGfx.S1SO_H)) ? 1 : sizeof(NGPGfx.S1SO_H)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.S1SO_H)) ? 0x08000000 : 0), "S1SO_H" },
      { &(NGPGfx.S1SO_V), (uint32_t)(SF_IS_BOOL(&(NGPGfx.S1SO_V)) ? 1 : sizeof(NGPGfx.S1SO_V)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.S1SO_V)) ? 0x08000000 : 0), "S1SO_V" },
      { &(NGPGfx.S2SO_H), (uint32_t)(SF_IS_BOOL(&(NGPGfx.S2SO_H)) ? 1 : sizeof(NGPGfx.S2SO_H)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.S2SO_H)) ? 0x08000000 : 0), "S2SO_H" },
      { &(NGPGfx.S2SO_V), (uint32_t)(SF_IS_BOOL(&(NGPGfx.S2SO_V)) ? 1 : sizeof(NGPGfx.S2SO_V)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.S2SO_V)) ? 0x08000000 : 0), "S2SO_V" },
      { &(NGPGfx.WBA_H), (uint32_t)(SF_IS_BOOL(&(NGPGfx.WBA_H)) ? 1 : sizeof(NGPGfx.WBA_H)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.WBA_H)) ? 0x08000000 : 0), "WBA_H" },
      { &(NGPGfx.WBA_V), (uint32_t)(SF_IS_BOOL(&(NGPGfx.WBA_V)) ? 1 : sizeof(NGPGfx.WBA_V)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.WBA_V)) ? 0x08000000 : 0), "WBA_V" },
      { &(NGPGfx.WSI_H), (uint32_t)(SF_IS_BOOL(&(NGPGfx.WSI_H)) ? 1 : sizeof(NGPGfx.WSI_H)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.WSI_H)) ? 0x08000000 : 0), "WSI_H" },
      { &(NGPGfx.WSI_V), (uint32_t)(SF_IS_BOOL(&(NGPGfx.WSI_V)) ? 1 : sizeof(NGPGfx.WSI_V)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.WSI_V)) ? 0x08000000 : 0), "WSI_V" },
      { &(NGPGfx.C_OVR), (uint32_t)(SF_IS_BOOL(&(NGPGfx.C_OVR)) ? 1 : sizeof(NGPGfx.C_OVR)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.C_OVR)) ? 0x08000000 : 0), "C_OVR" },
      { &(NGPGfx.BLNK), (uint32_t)(SF_IS_BOOL(&(NGPGfx.BLNK)) ? 1 : sizeof(NGPGfx.BLNK)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.BLNK)) ? 0x08000000 : 0), "BLNK" },
      { &(NGPGfx.PO_H), (uint32_t)(SF_IS_BOOL(&(NGPGfx.PO_H)) ? 1 : sizeof(NGPGfx.PO_H)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.PO_H)) ? 0x08000000 : 0), "PO_H" },
      { &(NGPGfx.PO_V), (uint32_t)(SF_IS_BOOL(&(NGPGfx.PO_V)) ? 1 : sizeof(NGPGfx.PO_V)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.PO_V)) ? 0x08000000 : 0), "PO_V" },
      { &(NGPGfx.P_F), (uint32_t)(SF_IS_BOOL(&(NGPGfx.P_F)) ? 1 : sizeof(NGPGfx.P_F)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.P_F)) ? 0x08000000 : 0), "P_F" },
      { &(NGPGfx.BG_COL), (uint32_t)(SF_IS_BOOL(&(NGPGfx.BG_COL)) ? 1 : sizeof(NGPGfx.BG_COL)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.BG_COL)) ? 0x08000000 : 0), "BG_COL" },
      { &(NGPGfx.CONTROL_2D), (uint32_t)(SF_IS_BOOL(&(NGPGfx.CONTROL_2D)) ? 1 : sizeof(NGPGfx.CONTROL_2D)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.CONTROL_2D)) ? 0x08000000 : 0), "CONTROL_2D" },
      { &(NGPGfx.CONTROL_INT), (uint32_t)(SF_IS_BOOL(&(NGPGfx.CONTROL_INT)) ? 1 : sizeof(NGPGfx.CONTROL_INT)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.CONTROL_INT)) ? 0x08000000 : 0), "CONTROL_INT" },
      { &(NGPGfx.SCREEN_PERIOD), (uint32_t)(SF_IS_BOOL(&(NGPGfx.SCREEN_PERIOD)) ? 1 : sizeof(NGPGfx.SCREEN_PERIOD)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.SCREEN_PERIOD)) ? 0x08000000 : 0), "SCREEN_PERIOD" },
      { &(NGPGfx.K2GE_MODE), (uint32_t)(SF_IS_BOOL(&(NGPGfx.K2GE_MODE)) ? 1 : sizeof(NGPGfx.K2GE_MODE)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.K2GE_MODE)) ? 0x08000000 : 0), "K2GE_MODE" },

      { (NGPGfx.SPPLT), (uint32_t)(6), 0 | SF_FORCE_A8(NGPGfx.SPPLT), "SPPLT" },
      { (NGPGfx.SCRP1PLT), (uint32_t)(6), 0 | SF_FORCE_A8(NGPGfx.SCRP1PLT), "SCRP1PLT" },
      { (NGPGfx.SCRP2PLT), (uint32_t)(6), 0 | SF_FORCE_A8(NGPGfx.SCRP2PLT), "SCRP2PLT" },

      { &(NGPGfx.winx), (uint32_t)(SF_IS_BOOL(&(NGPGfx.winx)) ? 1 : sizeof(NGPGfx.winx)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.winx)) ? 0x08000000 : 0), "winx" },
      { &(NGPGfx.winw), (uint32_t)(SF_IS_BOOL(&(NGPGfx.winw)) ? 1 : sizeof(NGPGfx.winw)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.winw)) ? 0x08000000 : 0), "winw" },
      { &(NGPGfx.winy), (uint32_t)(SF_IS_BOOL(&(NGPGfx.winy)) ? 1 : sizeof(NGPGfx.winy)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.winy)) ? 0x08000000 : 0), "winy" },
      { &(NGPGfx.winh), (uint32_t)(SF_IS_BOOL(&(NGPGfx.winh)) ? 1 : sizeof(NGPGfx.winh)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.winh)) ? 0x08000000 : 0), "winh" },
      { &(NGPGfx.scroll1x), (uint32_t)(SF_IS_BOOL(&(NGPGfx.scroll1x)) ? 1 : sizeof(NGPGfx.scroll1x)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.scroll1x)) ? 0x08000000 : 0), "scroll1x" },
      { &(NGPGfx.scroll1y), (uint32_t)(SF_IS_BOOL(&(NGPGfx.scroll1y)) ? 1 : sizeof(NGPGfx.scroll1y)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.scroll1y)) ? 0x08000000 : 0), "scroll1y" },
      { &(NGPGfx.scroll2x), (uint32_t)(SF_IS_BOOL(&(NGPGfx.scroll2x)) ? 1 : sizeof(NGPGfx.scroll2x)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.scroll2x)) ? 0x08000000 : 0), "scroll2x" },
      { &(NGPGfx.scroll2y), (uint32_t)(SF_IS_BOOL(&(NGPGfx.scroll2y)) ? 1 : sizeof(NGPGfx.scroll2y)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.scroll2y)) ? 0x08000000 : 0), "scroll2y" },
      { &(NGPGfx.scrollsprx), (uint32_t)(SF_IS_BOOL(&(NGPGfx.scrollsprx)) ? 1 : sizeof(NGPGfx.scrollsprx)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.scrollsprx)) ? 0x08000000 : 0), "scrollsprx" },
      { &(NGPGfx.scrollspry), (uint32_t)(SF_IS_BOOL(&(NGPGfx.scrollspry)) ? 1 : sizeof(NGPGfx.scrollspry)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.scrollspry)) ? 0x08000000 : 0), "scrollspry" },
      { &(NGPGfx.planeSwap), (uint32_t)(SF_IS_BOOL(&(NGPGfx.planeSwap)) ? 1 : sizeof(NGPGfx.planeSwap)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.planeSwap)) ? 0x08000000 : 0), "planeSwap" },
      { &(NGPGfx.bgc), (uint32_t)(SF_IS_BOOL(&(NGPGfx.bgc)) ? 1 : sizeof(NGPGfx.bgc)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.bgc)) ? 0x08000000 : 0), "bgc" },
      { &(NGPGfx.oowc), (uint32_t)(SF_IS_BOOL(&(NGPGfx.oowc)) ? 1 : sizeof(NGPGfx.oowc)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.oowc)) ? 0x08000000 : 0), "oowc" },

      { &(NGPGfx.negative), (uint32_t)(SF_IS_BOOL(&(NGPGfx.negative)) ? 1 : sizeof(NGPGfx.negative)), 0x80000000 | (SF_IS_BOOL(&(NGPGfx.negative)) ? 0x08000000 : 0), "negative" },

      { (NGPGfx.ScrollVRAM), (uint32_t)(4096), 0 | SF_FORCE_A8(NGPGfx.ScrollVRAM), "ScrollVRAM" },
      { (NGPGfx.CharacterRAM), (uint32_t)(8192), 0 | SF_FORCE_A8(NGPGfx.CharacterRAM), "CharacterRAM" },
      { (NGPGfx.SpriteVRAM), (uint32_t)(256), 0 | SF_FORCE_A8(NGPGfx.SpriteVRAM), "SpriteVRAM" },
      { (NGPGfx.SpriteVRAMColor), (uint32_t)(0x40), 0 | SF_FORCE_A8(NGPGfx.SpriteVRAMColor), "SpriteVRAMColor" },
      { (NGPGfx.ColorPaletteRAM), (uint32_t)(0x200), 0 | SF_FORCE_A8(NGPGfx.ColorPaletteRAM), "ColorPaletteRAM" },
