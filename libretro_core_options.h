...
struct retro_core_option_definition option_defs_us[] = {
   ...
   },
   {
      "ngp_videolayout",
      "Video Mix Layout",
      "Layout when displaying both screens.",
      {
         { "h",  "Horizontal" },
         { "v",  "Vertical" },
         { "sh",  "Horizontal (Switched)" },
         { "sv",  "Vertical (Switched)" },
         { NULL, NULL},
      },
      "h",
   },
   {
      "ngp_audiomix",
      "Audio Mix Mode",
      "Choose which screens to play audio for.",
      {
         { "p1",  "Play P1 Audio Only" },
         { "p2",  "Play P2 Audio Only" },
         { "both",  "Play Audio from Both Players" },
         { "match",  "Match Video Mix" },
         { NULL, NULL},
      },
      "both",
   },
